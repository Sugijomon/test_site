    ...
    this.innerHTML = `
      <header class="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-2 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-full mt-6 mx-4 md:mx-auto max-w-4xl shadow-2xl shadow-sky-900/10">
        ...
        <nav class="hidden md:flex gap-8 items-center">
          ...
          <a href="JOUW_LINK_HIER" class="text-slate-600 dark:text-slate-400 hover:text-sky-600 transition-colors font-medium">Insights</a>
          <a href="JOUW_LINK_HIER" class="text-slate-600 dark:text-slate-400 hover:text-sky-600 transition-colors font-medium">Over</a>
          <a href="JOUW_LINK_HIER" class="text-slate-600 dark:text-slate-400 hover:text-sky-600 transition-colors font-medium">Contact</a>
        </nav>
        
        <div class="flex items-center gap-2">
          <a href="JOUW_LINK_HIER" class="hidden md:block bg-primary text-on-primary px-6 py-2 rounded-full font-bold hover:bg-primary-container transition-all scale-95 active:scale-90 shadow-lg shadow-primary/20">
            Demo aanvragen
          </a>
        ...
        <div id="mobile-menu" class="hidden absolute top-[120%] left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-6 flex-col gap-2 md:hidden origin-top transition-all overflow-y-auto max-h-[80vh]">
          ...
          <a href="JOUW_LINK_HIER" class="text-slate-600 dark:text-slate-400 hover:text-sky-600 font-medium text-lg border-b border-slate-100 dark:border-slate-800 py-3">Insights</a>
          <a href="JOUW_LINK_HIER" class="text-slate-600 dark:text-slate-400 hover:text-sky-600 font-medium text-lg border-b border-slate-100 dark:border-slate-800 py-3">Over</a>
          <a href="JOUW_LINK_HIER" class="text-slate-600 dark:text-slate-400 hover:text-sky-600 font-medium text-lg border-b border-slate-100 dark:border-slate-800 py-3">Contact</a>
          
          <a href="JOUW_LINK_HIER" class="block w-full text-center bg-primary text-on-primary px-6 py-4 rounded-full font-bold mt-4 hover:bg-primary-container transition-colors active:scale-95 shadow-lg shadow-primary/20">
            Demo aanvragen
          </a>
        </div>
      </header>
        ...
        <div class="max-w-7xl mx-auto px-4">
          <div class="grid grid-cols-1 md:grid-cols-4 border-t border-slate-200 dark:border-slate-700">
            ...
            <div class="py-12 md:pr-8 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-700 flex flex-col items-start gap-4">
              <a href="/"><img src="https://insights.digidactics.nl/content/images/2026/03/Logo-without-bg.png" alt="Digidactics Logo" class="h-8 mb-4 hover:opacity-80 transition-opacity"></a>
            ...
            <div class="py-12 md:pl-8">
              ...
              <ul class="space-y-2 text-slate-500 text-sm">
                <li><a href="JOUW_LINK_HIER" class="hover:underline decoration-[#b9025f] decoration-2 underline-offset-4">Privacy Policy</a></li>
                <li><a href="JOUW_LINK_HIER" class="hover:underline decoration-[#b9025f] decoration-2 underline-offset-4">Terms of Service</a></li>
                <li><a href="JOUW_LINK_HIER" class="hover:underline decoration-[#b9025f] decoration-2 underline-offset-4">Cookie Instellingen</a></li>
              </ul>
            </div>
          </div>
